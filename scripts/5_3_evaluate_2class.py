# -*- coding: utf-8 -*-
"""
5_3_evaluate_2class.py

EVALUATION SCRIPT FOR 2-CLASS MODEL
====================================

Evaluates the trained ResNet + LSTM on test set (2 classes only).

INPUT:  D:/Research/Cancer_Cell_Analysis/dataset_2class/
OUTPUT: D:/Research/Cancer_Cell_Analysis/dl_output_2class/evaluation/

Run: python -u scripts/5_3_evaluate_2class.py
...
def plot_confusion_matrix(y_true, y_pred, class_names, output_path):
    ...
    ax.set_title('Confusion Matrix - 2-Class Test Set', fontsize=15, fontweight='bold')
...
def plot_roc_curve(y_true, y_probs, output_path):
    ...
    # Get probability of positive class (contain_cell)
    y_score = y_probs[:, 1]
    ...
    ax.set_title('ROC Curve - 2-Class Classification', fontsize=14, fontweight='bold')
...
def plot_per_class_metrics(y_true, y_pred, class_names, output_path):
    ...
    ax.set_title('Per-Class Metrics (2-Class)', fontsize=15, fontweight='bold')
...
def plot_sample_predictions(test_dataset, model, device, output_path, num_samples=12):
    ...
    plt.suptitle('Sample Predictions - 2-Class (Green=Correct, Red=Wrong)', 
...
def main():
    print("=" * 70)
    print("  EVALUATION: ResNet-18 + LSTM (2-CLASS)")
    ...
    if not os.path.exists(CHECKPOINT_PATH):
        ...
        print("  Please run 5_2_train_2class.py first!", flush=True)
        sys.exit(1)
    ...
    # Summary
    print("\n" + "=" * 70)
    print("  ✅ EVALUATION COMPLETE (2-CLASS)!")
    print("=" * 70)
    ...
    print("=" * 70)
    print(f"\n      3-Class Test Accuracy: 71.68%")
    print(f"      2-Class Test Accuracy: {test_acc:.2f}%")
    print(f"      Improvement: {test_acc - 71.68:+.2f}%")
    print("=" * 70)
